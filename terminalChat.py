...
def index():
    ...
    if request.method == 'POST':
        ...
        if user and user.check_password(password):
            ...
            print('fatnigga') # This is the function provided by Flask-Login to log in a user.
...
def dashboard():
    ...
    if request.method == 'POST':
        # Get the name of the chatroom from the form data
        ...
        if chatroom_name:
            ...
            try:
                ...
                db.session.rollback()
                flash('Error adding chat room: {}'.format(e), 'danger')
        else:
